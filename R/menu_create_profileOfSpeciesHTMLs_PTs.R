...
menu_create_profileOfSpeciesHTMLs_PTs <- function(){


  cat("\nMenu to create the species profile HTMLs for PT species:\n(press '0' to exit)\n\n")
  ...
  switch(
    ...
    # Actions
    cat("Nothing done\n"),
    create_profileOfSpeciesHTML_create_scripts("PT"),
    create_profileOfSpeciesHTML_execute_scripts("PT"),
