create_profileOfSpeciesHTML_check_files <- function(){
  ...
  for(element in listOfSpecies$V1){
    ...
    df_scripts <-
      file.info(
        ...
        paste0(getwd(), "/CNCFlora_data/outputs/profileOfSpeciesHTML scripts/", element, " - script.R")
    ...
    df_results <-
      file.info(
        ...
        paste0(
          ...
          getwd(),
          "/CNCFlora_data/outputs/profileOfSpeciesHTML results/",
          element,
          ".html"
