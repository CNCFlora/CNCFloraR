  ...
  switch(
    ...
    menu(
      ...
      c(
        ...
        "To autofill profiles in oldSystem using AutoHotKey",
    ...
    prepare_listOfSpecies_files_to_autofill_profile_in_oldSystem(onlyNonFilledProfile = T, ask_to_open_file = T, ask_to_write_file = T),
