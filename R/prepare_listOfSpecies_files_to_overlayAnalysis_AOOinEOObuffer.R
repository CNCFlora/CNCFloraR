prepare_listOfSpecies_files_to_overlayAnalysis_AOOinEOObuffer <- function(onlyNonExistentAnalysis = F){
  ...
  # Ask to write the `species_landCover-MapBiomas_by_AOOinEOObuffer.csv` file
  ...
  while(
    ...
    answer <-
      toupper(readline("Write the list of species file (species_landCover-MapBiomas_by_AOOinEOObuffer.csv)? (y/n): "))
